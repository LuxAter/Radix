#ifndef RADIX_LOG_HPP_
#define RADIX_LOG_HPP_
...
#define Set(logger) Logger::Get()->SetDefault(logger)
#define Fatal(msg, ...)                                                    \
      ...
      if (setting) {
        this->log_fmt_ = {
            {"\033[1;31m[__TYPE__] <__DATE_TIME__> "
             ...
             "__BODY__\033[0m",
             "\033[1;32m[__TYPE__] <__DATE_TIME__> (__FILE__:__FUNC__:__LINE__) "
             "__BODY__\033[0m",
             "\033[1;34m[__TYPE__] <__DATE_TIME__> (__FILE__:__FUNC__:__LINE__) "
             "__BODY__\033[0m",
             "\033[1;35m[__TYPE__] <__DATE_TIME__> (__FILE__:__FUNC__:__LINE__) "
             "__BODY__\033[0m",
